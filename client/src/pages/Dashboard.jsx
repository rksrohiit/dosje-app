...
import { Building2, Activity, ClipboardCheck, AlertCircle, Camera, ShieldCheck, MapPin } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-blue-900 via-slate-900 to-indigo-900 rounded-2xl p-5 md:p-6 text-white shadow-lg border border-blue-800/40">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md px-4 py-2.5 rounded-xl border border-white/15 self-start sm:self-auto">
            ...
            <div>
              <p className="text-[10px] uppercase font-bold text-slate-300">National Compliance</p>
              <p className="text-base font-extrabold text-white">{stats.compliance_avg}%</p>
            </div>
          </div>
        </div>
      </div>
